...
ADMISSION, BRANCH, SOURCE, SOURCE_TREE = "2aa64301b308e9a49054bc9d8c6a63a9656b008115cbe67b008e10c79fbd35f9", "remediation/app-two-batch-shared-android-20260915-02", "1a12801b279cc60618535673104c52ad3735faf2", "af3543d07782927aefba9a7303ee8eabcc27ac56"
...
CARRIED = {
    "app10_cold_root_support.py": "65136a88b3aeab608f10bddc4e8d84c1d88815a0ed858518b9527c33c8e9358d",
    "app10_cold_root_ui.py": "e66532035bab0756d377907adcb43c95712d4e9733746b0b451b97cb46fa24bf",
    "app10-original-engine.init.gradle": "4b0511489b23c09d9580c0d4d7fafbb4172db9c432535dbe8ba26b0b53e486c9",
    "app29_linux_owned_processes.py": "ac6fb4b61186c09ab06f9b4a543cb58e65dcbcdfe6ba405f6afbe1814b7fc455",
    "app10-android-observer.gradle": "0920055aeb0a573c60a9f72e25a372882f7b1151dd80a159c6990b9b2747a149",
    "app10-android-portfolio.json": "9b201cf34b859ab91a9f556a07ce12abb75049bc166e071b710eccd3fa16595c",
    "app10_android_evidence.py": "7c134cf5ffccc789b423bffce36fda8b6caac4e47efd0f3375fcb5daca690201",
}
...
def gradle_batch(lane, state, inputs, portfolio, avif, device=False):
    ...
    require(state.get(phase + "_stop_ok"), "Successful immediate owned Gradle stop required after each batch")
...
def execute(lane, sdk, state, inputs):
    ...
    require(state["observation"] is not None and state["observation"]["status"] == "OBSERVED_PASS", "Existing real App10 UI proof required first")
    state["ui_completed"] = True
    require(sha(apk) == inputs["apk"]["sha256"], "Staged ordinary APK changed during UI")
    apk.unlink()  # Real UI install was its last consumer; APKs are never public artifacts.
    ...
    lane.foreground_drain()
    delete_build(state)  # Last Gradle/APK consumer ended, only explicitly owned services remain.
...
def main():
    ...
    scope = "Host8+DI2 / one ordinary APK / existing fresh App10 UI first / ordinary native-device9; no Linux41, carry rerun, API26/27, other-ABI runtime,16KiB device or release closure"
