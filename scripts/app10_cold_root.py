...
ADMISSION, BRANCH, SOURCE, SOURCE_TREE = "kira-app10-cold-root-admitted-20260914-01", "remediation/app-10-cold-root-validation-01", "3bf84b408828cd370c30b72ecf9014d2763c3f5a", "5260345586754b1c69ea2172044e0f0d1149bc6f"
...
def main():
    ...
    try:
        ...
        release = properties(regular(Path("/etc/os-release").resolve(), 65536))
        require(release.get("ID") == "ubuntu" and release.get("VERSION_ID") == '"24.04"', "Only Ubuntu24.04")
        require(b'JAVA_VERSION="21.' in regular(java / "release", 65536), "Installed JDK21 required")
        ...
        inputs["jdk"] = dict(release_sha256=sha(java / "release"), java_sha256=sha(java / "bin/java"))
