#!/usr/bin/env python3
"""UNBOUND / NOT_RUN. Consolidated host29, APK provenance and native-device9, never UI."""
import os
import sys

ADMISSION, BRANCH, SOURCE, SOURCE_TREE = "APP_NEXT_MOBILE_HOST29_NATIVE9_20260915_02", "remediation/app-next-mobile-host29-native9-20260915-02", "5195cc4132868c417824875bf7fdf71f76483a7b", "75b725541c183f24f0ed888259a6b8348e1be5d3"
MODE = "native-only"  # Fixed reviewed host29 + APK + native9; no UI mode or caller-selected test expansion.
...
CARRIED = {
    ...
    "app10-original-engine.init.gradle": "d3a4502b5b3772aadad28fc53f6386755f02e41f8de3cfff9e8d7f4b6bbca3b0",
    ...
    "app10-android-portfolio.json": "74f8e2769d8de78a5592ea072d9b8c8978050b77894c5b12733c317f9d8260b8",
    "app10_android_evidence.py": "c160394b99afd6ab03881f284429236c909026532d7161508d0a149d30d2a21c",
}
...
def execute(lane, sdk, state, inputs):
    ...
    require(changed == ["A\t" + p for p in CONTROLS], "Carrier must add exactly the eight reviewed host29/native9 controls")
    ...
    require([(s["task"], s["compiler"], s["platform"], s["target"], s["classes"]) for s in portfolio["tests"]] ==
            [(":app:testDebugUnitTest", ":app:compileDebugUnitTestKotlin", "androidJvm", "android", ['me.manga.kira.di.AndroidAppVersionBindingTest', 'me.manga.kira.core.util.notification.ChapterNotificationHelperTest', 'me.manga.kira.work.LibraryRefreshNotificationTest', 'me.manga.kira.work.LibraryRefreshWorkTest'])],
            "Only the exact four-class29-method app host roster is admitted")
...
def main():
    ...
    validation_ok = state.get("device_completed") and all(state.get(phase + suffix, False)
    ...
    scope = "Exactly29 app host methods / one ordinary APK for provenance / exactly nine native-device classes / no UI automation; historical Android09 FAIL unchanged; no current-source carry upgrade, Linux41, fullmatrix, API26/27, other-ABI runtime,16KiB device or release closure"
