#!/usr/bin/env python3
"""PREPARED / NOT_RUN. Native37/9 continuation; source-identical host29/APK carried, never UI."""
import os
import sys

ADMISSION, BRANCH, SOURCE, SOURCE_TREE = "APP_NEXT_MOBILE_NATIVE9_CONTINUATION_20260915_03", "remediation/app-next-mobile-native9-continuation-20260915-03", "5195cc4132868c417824875bf7fdf71f76483a7b", "75b725541c183f24f0ed888259a6b8348e1be5d3"
...
CARRIED = {
    ...
    "app10-android-portfolio.json": "2cad6d782112a75b83405d1547e608b23ffc34efe53f947835120856debf2517",
...
def execute(lane, sdk, state, inputs):
    ...
    require(carry["run_id"] == 34952259413 and carry["source"] == [SOURCE, SOURCE_TREE] and
            carry["overall_run_status"] == "FAIL" and carry["host_tests"] ==
            {"pass": 29, "fail": 0, "skip": 0, "fresh_in_this_continuation": False},
            "Only the separately verified source-identical host29/APK carry; prior overall FAIL stays")
...
def main():
    ...
    scope = "Native continuation: exactly37 authored methods/nine classes; host29 PASS and production APK carried from source-identical run34952259413, not rerun/rebuilt/downloaded; that run and historical Android09 stay FAIL; no UI, Linux41, fullmatrix, API26/27, other-ABI runtime,16KiB device or release closure"
