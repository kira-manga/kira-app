...
METHODS['dao.ChapterArtifactRepairDaoTest'] = ['lateArtifactWriteFailureRollsBackSavedMirrorsAndLedgerAcrossReopen']
...
def prepare():
    ...
    require(os.environ['GITHUB_EVENT_NAME'] == 'push' and os.environ['GITHUB_REPOSITORY'] == 'kira-manga/kira-app'
            and os.environ['GITHUB_REF'] == 'refs/heads/remediation/app32-schema17-linux-20260920-03'
