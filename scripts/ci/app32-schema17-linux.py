...
def prepare():
    ...
    require(os.environ['GITHUB_EVENT_NAME'] == 'push' and os.environ['GITHUB_REPOSITORY'] == 'kira-manga/kira-app'
            and os.environ['GITHUB_REF'] == 'refs/heads/remediation/app32-schema17-linux-20260919-01'
...
def verify():
    ...
    require(len(graphs) == 1 and len(graphs[0]) == 24 and len(set(graphs[0])) == 24, 'Normal graph evidence missing')
