...
COMPILES = [':app:compileDebugKotlin']
# Remaining five Test tasks; carry54 unchanged passes from Linux05. Include affected discovery/fixture tests.
TESTS = {
    ":data:desktopTest": [
        ...
        "me.manga.kira.data.repository.ChapterFinalizerCompletenessTest.aCompleteLooseRosterCanStillFinishWhenCbzIsDisabled",
        "me.manga.kira.data.repository.MissingDownloadMetadataRepairTest.absentRootClearsOnlyOfflineClaimsAndSurvivesReopenWithoutRecreatingHistory",
        "me.manga.kira.data.repository.MissingDownloadMetadataRepairTest.mirrorsWithDifferentOwnerIdentityRemainUntouched"
    ],
    ...
    ":app:testDebugUnitTest": [
        ...
        "me.manga.kira.work.LibraryRefreshDiscoveryOwnershipTest",
        "me.manga.kira.core.util.notification.ChapterNotificationHelperTest",
        "me.manga.kira.core.util.notification.ChapterNotificationResourceLocaleTest"
    ]
}
