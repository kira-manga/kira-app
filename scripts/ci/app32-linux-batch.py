...
def verify_tests(reports):
    ...
    require(not errors and len(ids) == 24 and len(ids) == len(set(ids)) and covered,
            'Require exactly twenty-four selected tests, fresh XML, no extras/duplicates/failures/skips')
