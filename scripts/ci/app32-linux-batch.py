...
COMPILES = []
# Original identity obligations, failed07 cases, and previously uncompiled Android-host tasks only.
TESTS = {
    ":data:desktopTest": [
        "me.manga.kira.data.repository.LibraryRepositoryAddTest.addToLibrary_is_idempotent_and_inserts_only_new_chapter_urls",
        "me.manga.kira.data.repository.LibraryIdentityRuntimeTest.accepted_alias_and_renamed_metadata_keep_the_stored_parent_id_and_raw_url",
        "me.manga.kira.data.repository.LibraryIdentityRuntimeTest.metadata_after_affinity_open_and_child_writes_preserves_all_user_state",
        "me.manga.kira.data.repository.LibraryIdentityRuntimeTest.same_title_distinct_works_resolve_and_mutate_by_owner_only",
        "me.manga.kira.data.repository.LibraryRepositoryRemoveTest.removeFromLibrary_purges_download_rows_and_deletes_files",
        "me.manga.kira.data.backup.BackupOwnedMergeTest.renamed_same_url_and_distinct_same_title_selection_never_use_display_identity",
        "me.manga.kira.data.backup.BackupOwnedMergeTest.entire_incoming_alias_families_are_checked_before_a_first_group_writes",
        "me.manga.kira.data.backup.BackupCodecRoundTripTest.decoder_ignores_unknown_keys_and_fills_defaults",
        "me.manga.kira.data.backup.BackupRepositoryEndToEndTest.repeatedImportKeepsTheCommittedGenerationAndReexportsIt",
        "me.manga.kira.data.backup.BackupRepositoryEndToEndTest.oldHostPackage_mergesIntoCurrentHostWithoutDuplicatingOwnersOrPackedDownloads",
        "me.manga.kira.data.backup.BackupOwnershipAdmissionJoinTest.ambiguousFormatOneAliasesFailBeforeImportingEitherWork",
        "me.manga.kira.data.repository.progress.ScopedProgressAliasTest.adoption_preserves_unsaved_anchor_ids_epochs_and_page_and_read_only_alias_lookup_does_not_move",
        "me.manga.kira.data.repository.progress.ScopedProgressAliasTest.a_late_chapter_move_failure_rolls_back_the_earlier_work_move",
        "me.manga.kira.data.repository.progress.LegacyProgressTransferTest.unique_saved_owner_commits_copy_and_full_receipt_before_settings_cleanup",
        "me.manga.kira.data.repository.progress.LegacyProgressReopenTest.cancellation_after_copy_commit_preserves_pending_receipt_and_settings_for_reopening",
        "me.manga.kira.data.repository.progress.LegacyProgressReopenTest.remove_before_acknowledgement_failure_reopens_pending_and_acknowledges_absence_without_copy",
        "me.manga.kira.data.repository.selection.StrictSelectionMigrationTest.savedAndIndependentAnchorsRetainEveryNonUrlColumnAfterReopen"
    ],
    ":presentation:desktopTest": [
        "me.manga.kira.presentation.details.DetailsWorkIdentityTest.fetchedRename_retainsMembershipOriginalOwnerAndPortableExport"
    ],
    ":composeApp:desktopTest": [
        "me.manga.kira.sources.runtime.RoomDownloadCatalogAdmissionTest.callerFailureIsNotRelabeledAsPreCaptureNotReady",
    ...
    ":app:testDebugUnitTest": [
        "me.manga.kira.core.util.notification.ChapterNotificationResourceLocaleTest.blockedSameIdChannelKeepsItsUserStateWhenTheHelperRelabelsIt[32]",
        "me.manga.kira.core.util.notification.ChapterNotificationResourceLocaleTest.actualBuildSnapshotsTheNewSelectionAfterItsCoverAwait[32]",
        "me.manga.kira.core.util.notification.ChapterNotificationResourceLocaleTest.sameActualKoinHelperUsesLatestLanguageOnNextBuildWithOrWithoutACover[32]"
    ]
}
