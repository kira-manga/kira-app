#!/usr/bin/env python3
"""One ordinary App84 Android/locale and selected shared-test invocation. No schema replay."""
import json
import os
...
COMPILES = [':composeApp:compileAndroidMain', ':ui:checkLocaleKeyParity']
# App84: existing action, real-route and affected layout/selection coverage only.
TESTS = {
    ":presentation:desktopTest": [
        "me.manga.kira.presentation.details.DetailsViewModelShareTest"
    ],
    ":ui:desktopTest": [
        "me.manga.kira.ui.details.DetailsScreenActionsTest",
        "me.manga.kira.ui.details.DetailsScreenSelectionTest",
        "me.manga.kira.ui.details.DetailsScreenBottomControlsTest"
    ],
    ":composeApp:desktopTest": [
        "me.manga.kira.navigation.routes.DetailsShareRouteTest"
    ]
}
