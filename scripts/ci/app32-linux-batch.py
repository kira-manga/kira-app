...
COMPILES = []
# Only the newly reviewed actual fallback-worker witness; carry all unchanged successes.
TESTS = {':data:desktopTest': ['me.manga.kira.data.repository.CoroutineDownloadStartupAdmissionTest.unreadyStartupParksUntilExternalResumeAndEachChapterNeedsAdmission']}
