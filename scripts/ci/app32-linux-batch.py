...
def verify_tests(reports):
    ...
    require(not errors and len(ids) == 4 and len(ids) == len(set(ids)) and covered,
            'Require exactly four selected tests, fresh XML, no extras/duplicates/failures/skips')
