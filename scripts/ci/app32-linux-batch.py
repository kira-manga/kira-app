...
TESTS = {
    ...
    ':app:testDebugUnitTest': [
        ...
        'me.manga.kira.work.LibraryRefreshWorkTest.equalCoverWithNoNewChapters_stillRepairsMetadata_butBlankCoverIsSkipped',
        'me.manga.kira.work.LibraryRefreshWorkTest.lostDiscoveryRace_isSuccess_andOnlyCommittedNotificationsAreCounted',
        'me.manga.kira.work.LibraryRefreshWorkTest.cancellationDuringReadCoverInsertOrStamp_propagates_withoutMetadataRollback',
