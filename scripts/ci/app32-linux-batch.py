#!/usr/bin/env python3
"""One ordinary App84 affected-four shared-test invocation. No repeated Android/locale/UI suite."""
import json
import os
...
COMPILES = []
# App84: both affected presentation/real-route fixtures; earlier UI11 carried.
TESTS = {
