...
METHODS = {
    'SourceSelectionBootstrapTest': [
        'concurrent_callers_share_local_preparation_and_one_cancellation_is_isolated',
        'last_waiter_cancellation_retains_closing_until_the_actual_cleanup_returns',
        'a_shared_failure_is_unchanged_and_only_explicit_later_calls_prepare_again',
        'owner_and_graph_close_reject_new_calls_but_still_own_the_running_cleanup',
        'cancel_before_body_does_no_local_work_or_strand_a_live_owner',
    ],
}
...
def prepare():
    ...
    require(os.environ['GITHUB_EVENT_NAME'] == 'push' and os.environ['GITHUB_REPOSITORY'] == 'kira-manga/kira-app'
            and os.environ['GITHUB_REF'] == 'refs/heads/remediation/app32-bootstrap-owner-linux-20260919-01'
