#!/usr/bin/env python3
"""One source-bound Android union40 batch; results always need independent review."""
import os
import sys

if os.environ.get("APP72569_ADMISSION") != "primary-reviewed-app72569-linux-02" or len(sys.argv) != 1:
...
def main():
    ...
    record("result.json", dict(status="RESULT_REVIEW_REQUIRED" if eligible else "FAIL", checks=result, errors=ERRORS,
        ...
        limits="16MiB Gradle;8MiB provenance;512KiB other logs;1MiB XML;64KiB other JSON;19 files<=35MiB",
