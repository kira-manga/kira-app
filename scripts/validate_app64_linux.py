...
SOURCE = "f96c571edab9b5d79d8ed5e229d9eb0c18cc5459"
SOURCE_TREE = "6b755415991b78d09f0f85ffa7bb1f396b3ae187"
...
FILES = [CBZ + name + ".kt" for name in (
    "CbzFaultInjection", "CbzHostFixture", "CbzModeledAvifCase", "CbzObservedDecoder",
    "CbzReturnDispatcher", "OptimizedCbzCancellationTest", "OptimizedCbzRollbackTest", "OptimizedCbzStreamingTest",
)] + [SERVICE + name + ".kt" for name in ("CancellationFixtureService", "CbzServiceFailureTest")] + [
    PLATFORM + name + ".kt" for name in ("CbzArchiveOutput", "CbzImageDecoder", "OptimizedCbzManager")]
TESTS = [
