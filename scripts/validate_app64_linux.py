...
SOURCE = "fcb6ca8ddcfee5203e025a144c7d7f7b17005d2a"
SOURCE_TREE = "0ba206053fed72f616d7163b42955c986dcd54c4"
...
def preflight():
    global WORK_OWNED
    require(ENV.get("APP64_ADMISSION") == "primary-reviewed-app64-linux-04", "admission UNBOUND")
    for key, expected in {"GITHUB_ACTIONS": "true", "GITHUB_EVENT_NAME": "push",
                          "GITHUB_REPOSITORY": "kira-manga/kira-app", "GITHUB_RUN_ATTEMPT": "1",
                          "GITHUB_REF": "refs/heads/remediation/app-64-public-validation-04",
