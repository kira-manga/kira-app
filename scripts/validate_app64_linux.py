...
SOURCE = "e9742cb226e41eae7f0912964f9c2c995085d503"
SOURCE_TREE = "7c75355af1245c18749ad0fdd32e3979a81cf727"
...
def preflight():
    global WORK_OWNED
    require(ENV.get("APP64_ADMISSION") == "primary-reviewed-app64-linux-03", "admission UNBOUND")
    for key, expected in {"GITHUB_ACTIONS": "true", "GITHUB_EVENT_NAME": "push",
                          "GITHUB_REPOSITORY": "kira-manga/kira-app", "GITHUB_RUN_ATTEMPT": "1",
                          "GITHUB_REF": "refs/heads/remediation/app-64-public-validation-03",
