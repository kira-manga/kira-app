package me.manga.yamiapk.sources_repositry.tr.webtoontr
...
class WebtoontrRepository @Inject constructor(
    ...
    override suspend fun initSite(): Int {
        ...
        Log.i("WebtoontrInit", "Headers from DataStore: $headers")
        _cachedHeaders = headers
        Log.i("WebtoontrInit", "_cachedHeaders is now: $_cachedHeaders")
...
//            .distinct()
        Log.i("jkafhdjkfdasjfdskfjsdfsfssafdfds", imgs.toString())
