package me.manga.yamiapk.presentation.common.componants.scroll
    ...
    import me.manga.yamiapk.presentation.common.componants.scroll.Scroller.STICKY_HEADER_KEY_PREFIX
        ...
        SubcomposeLayout(modifier = modifier) { constraints ->
            ...
            val scrollerPlaceable = subcompose("scroller") {
                ...
                LaunchedEffect(listState.firstVisibleItemScrollOffset) {
                    ...
                    val proportion = if (available > 0f && available.isFinite()) (scrollOffset.toFloat() / available).coerceIn(0f, 1f) else 0f
