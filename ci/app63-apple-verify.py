...
def native():
    ...
    assert len(actual) == len(set(actual)) == 39 and set(actual) == expected, actual
    save('native-proof.json', {'status': 'PASS', 'cases': actual,
        'scope': 'Native platform27/data12; shared SQL migration and importer proof belongs to Linux gate'})
