"""Targeted Apple successor preparation: ordinary host, Native15 and UIKit7; agreement-gated."""
import hashlib
...
BRANCH = 'remediation/app-two-batch-shared-apple-20260915-08'
...
APP = {'repository': 'kira-manga/kira-app', 'sha': '6ee86ffbb3948eb910cc652dd00460573acdd3e2', 'tree': '831b401cfdf49c31ee2c1fd9cc3913fe6a1d1881'}
...
PLAN = 'aae93b4b5fa96c890c43bf536f97d0dc7cf9b7dee5d0b44f939fb14aa7a963ea'
AGREEMENT = '70c8da78437932574c9fd3013d56b9959491b03b415c2bc28e9190a63a66f4bf'
...
UIKIT_TESTS = {'target': 'ReaderChromeControlsTests', 'classes': ['ReaderImageDecodeTests'], 'caseCount': 7}
...
def finish(c):
    ...
    result['passed'] = bool(result.get('hostBuildSucceeded') and result.get('proofPreserved')
        ...
        and result.get('kotlinTestsExecuted') == 15 and result.get('uikitTestsExecuted') == c['uikitSource']['caseCount'] and result['sourcePreserved']
