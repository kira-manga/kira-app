"""Shared two-batch Apple preparation: ordinary host, Native57 and UIKit38; agreement-gated."""
import hashlib
...
BRANCH = 'remediation/app-two-batch-shared-apple-20260915-06'
...
APP = {'repository': 'kira-manga/kira-app', 'sha': '826d7d2eecbcc8c2f834cc202d188898e41fd64f', 'tree': 'e0e9400ace05d8e608e6f7765cd81f64cc3719e4'}
...
PLAN = 'e03c8efd69e5272b203e94a916c742e8934bfee3ba5f47c2ac32c247d8fe5aaa'
AGREEMENT = '5f634aa6bf2fb6fafe3729cbe0ef45b25dd2aa6a83d7055cb8a8138b4a0a3756'
...
NATIVE_TASKS = (':platform:iosSimulatorArm64Test', ':data:iosSimulatorArm64Test', ':data:download:iosSimulatorArm64Test')
UIKIT_TESTS = {'target': 'ReaderChromeControlsTests', 'classes': ['ReaderImageOwnershipTests', 'ReaderImageLoaderBehaviorTests', 'ReaderImageDecodeTests', 'ReaderPageTransportTests', 'ReaderPageCellOwnershipTests', 'WebtoonPrefetchOwnershipTests', 'WebtoonReaderBoundaryTests'], 'caseCount': 38}
...
def finish(c):
    ...
    result['passed'] = bool(result.get('hostBuildSucceeded') and result.get('proofPreserved')
        ...
        and result.get('kotlinTestsExecuted') == 57 and result.get('uikitTestsExecuted') == c['uikitSource']['caseCount'] and result['sourcePreserved']
