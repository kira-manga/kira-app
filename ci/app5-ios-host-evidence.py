...
# Additional build roots belong only to the fourteen observed SwiftPM metadata /
# umbrella prerequisites, not to additional compiler/link roots. All must be
# absent at admission and are removed only after the unchanged ownership barrier.
OUTPUTS = {'app': ('build', '.gradle', '.kotlin', 'core/build', 'platform/build',
    'composeApp/build', 'data/build', 'domain/build', 'presentation/build', 'ui/build',
    'data/download/build', 'data/local/build', 'data/remote/build',
    'sources/config/build', 'sources/contracts/build', 'sources/engine/build', 'sources/legacy/build')}
