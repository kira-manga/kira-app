"""Targeted mobile-owner-delete Native12; existing bounded retention/cleanup controls, no framework proof."""
import hashlib
import json
import os
...
NATIVE_XML = (
    'native-xml/data/remote/TEST-iosSimulatorArm64Test.me.manga.kira.data.remote.complaint.IosComplaintMutationOwnerDeleteTest.xml',
    'native-xml/data/remote/TEST-iosSimulatorArm64Test.me.manga.kira.data.remote.complaint.IosComplaintMutationOwnerDeleteReceiveGuardTest.xml',
