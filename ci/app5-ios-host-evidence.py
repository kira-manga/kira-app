"""Targeted mobile-edit Native13 evidence; the existing bounded retention/cleanup controls, no framework proof."""
import hashlib
import json
import os
...
NATIVE_XML = (
    'native-xml/data/remote/TEST-iosSimulatorArm64Test.me.manga.kira.data.remote.complaint.IosComplaintMutationEditTest.xml',
    'native-xml/data/remote/TEST-iosSimulatorArm64Test.me.manga.kira.data.remote.complaint.IosComplaintMutationEditReceiveGuardTest.xml',
