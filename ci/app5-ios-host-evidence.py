...
NATIVE_LOGS = ('native-tests', 'gradle-stop-native') + tuple(
    'native-' + module + '-' + kind for module in ('platform', 'data', 'data-download') for kind in ('arch', 'platform'))
NATIVE_XML = (
    'native-xml/platform/TEST-iosSimulatorArm64Test.me.manga.kira.platform.image.IosAvifDecoderTest.xml',
    'native-xml/platform/TEST-iosSimulatorArm64Test.me.manga.kira.platform.image.IosAvifDecoderFailureTest.xml',
    'native-xml/platform/TEST-iosSimulatorArm64Test.me.manga.kira.platform.cbz.IosCbzNativeOwnershipTest.xml',
    'native-xml/platform/TEST-iosSimulatorArm64Test.me.manga.kira.platform.cbz.IosCbzMemoryAdmissionTest.xml',
    'native-xml/platform/TEST-iosSimulatorArm64Test.me.manga.kira.platform.cbz.IosCbzCompletenessTest.xml',
    'native-xml/platform/TEST-iosSimulatorArm64Test.me.manga.kira.platform.cbz.IosCbzReaderValidationTest.xml',
    'native-xml/platform/TEST-iosSimulatorArm64Test.me.manga.kira.platform.media.IosPageMediaInspectorTest.xml',
    'native-xml/platform/TEST-iosSimulatorArm64Test.me.manga.kira.platform.download.IosBackgroundTransportTest.xml',
    'native-xml/platform/TEST-iosSimulatorArm64Test.me.manga.kira.platform.download.IosBackgroundCompletionTest.xml',
    'native-xml/data/TEST-iosSimulatorArm64Test.me.manga.kira.data.repository.IosCbzFinalizationTest.xml',
...
def inputs(root, role, pins):
    ...
    require(len(expected) == (64 if role == 'app' else 51) and all(not Path(n).is_absolute() and
    ...
    if role == 'app':
        ...
        require(files == expected_host and len(files) == 47 and
                len([n for n in files if n.endswith('.swift')]) == 20, 'Shipping host input set changed')
        result['host'] = files
    return result
