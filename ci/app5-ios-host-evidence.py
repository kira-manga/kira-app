"""Reduced reply+detail Native22 evidence; the existing bounded retention/cleanup controls, no framework proof."""
import hashlib
import json
import os
...
NATIVE_XML = (
    'native-xml/data/remote/TEST-iosSimulatorArm64Test.me.manga.kira.data.remote.complaint.IosComplaintMutationReplyTest.xml',
    'native-xml/data/remote/TEST-iosSimulatorArm64Test.me.manga.kira.data.remote.complaint.IosComplaintMutationEngineTest.xml',
    'native-xml/data/remote/TEST-iosSimulatorArm64Test.me.manga.kira.data.remote.complaint.IosComplaintMutationReceiveGuardTest.xml',
    'native-xml/data/remote/TEST-iosSimulatorArm64Test.me.manga.kira.data.remote.complaint.IosComplaintHistoryDetailTest.xml',
    'native-xml/data/remote/TEST-iosSimulatorArm64Test.me.manga.kira.data.remote.complaint.IosComplaintHistoryEngineTest.xml',
    'native-xml/data/remote/TEST-iosSimulatorArm64Test.me.manga.kira.data.remote.complaint.IosComplaintHistoryLifecycleTest.xml',
    'native-xml/data/remote/TEST-iosSimulatorArm64Test.me.manga.kira.data.remote.complaint.IosComplaintHistoryReceiveGuardTest.xml',
)
