...
class DownloadedPageFilesTest {
    ...
    @Test
    fun oneBadOrMissingMemberNeverReturnsAFilteredSubset() = runTest {
    ...
    @Test
    fun currentContainerIsPreferredButInvalidCurrentCanUseTheStoredImage() = runTest {
    ...
    @Test
    fun blankDuplicateEmptyAndOverBudgetRostersAreUnusable() = runTest {
    ...
    @Test
    fun cancellationFromInspectionPropagatesWithoutDeletingThePage() = runTest {
        val good = write(directory / "0.png", recoveryTestPng())
        val cancelled = object : PageMediaInspector by inspector {
