...
internal class IosCbzFinalizationFixture {
    ...
    suspend fun saved(original: IosCbzChapter): SavedChapterEntity = assertNotNull(
        db.chapterDao().getChapterByIdSuspend(original.saved.id),
    )

    suspend fun download(original: IosCbzChapter): ChapterDownloadEntity = assertNotNull(
