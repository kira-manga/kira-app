...
internal fun historyLocalFailure(outcome: Outcome<*>): AppResult.Failure =
    when (outcome) {
...
internal fun historySessionFailure(result: ComplaintSessionResult): AppResult.Failure =
    when (result) {
...
internal fun historyEnrollmentFailure(result: InstallationEnrollmentResult.Failure): AppResult.Failure =
    when (result) {
