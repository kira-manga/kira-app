...
class ComplaintListRepositoryImpl(
    ...
    private fun LegacyComplaint.toSummary(): ComplaintSummary =
        ComplaintSummary(
            id = id,
            userId = userId,
            type = type.toDomain(),
    ...
    private fun LegacyComplaintStatus.toDomain(): ComplaintStatus =
        when (this) {
    ...
    private fun LegacyComplaintType.toDomain(): ComplaintType =
        when (this) {
