...
/**
 * Owns only POST CREATE and operation-status at the exact HTTPS [createUrl] origin/base prefix.
 * [createUrl] must end in `/api/v1/complaints`, without credentials/query/fragment. Status is
 * derived under that same checked base. Invalid targets return null before native allocation.
