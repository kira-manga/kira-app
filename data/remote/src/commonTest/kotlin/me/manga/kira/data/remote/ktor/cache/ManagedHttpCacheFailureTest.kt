...
class ManagedHttpCacheFailureTest {
    @Test
    fun writeFailureDisablesFurtherGrowthUntilAnExplicitSuccessfulClear() = runTest {
    ...
    @Test
    fun failedClearIsReportedDropsLiveHitsAndKeepsWritesDisabled() = runTest {
        val disk = RecordingCachePersistence()
        val cache = cacheOwner(persistence = disk)
    ...
    @Test
    fun loadFailureDoesNotRetryAndAccumulateRecordsOnEveryRequest() = runTest {
    ...
    @Test
    fun failedEvictionDisablesWritesInsteadOfAllowingDiskGrowth() = runTest {
    ...
    @Test
    fun cancellationIsNotConvertedIntoACacheMissOrSuccessfulClear() = runTest {
