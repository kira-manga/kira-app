...
lines = [
  ...
  "- Beta App Review submitted: #{testflight['beta_review_submitted'] ? 'yes' : 'no'}",
  ...
  "",
  "This workflow uploads and processes the build only. External distribution and Beta App Review require a separate, explicitly approved action."
]
