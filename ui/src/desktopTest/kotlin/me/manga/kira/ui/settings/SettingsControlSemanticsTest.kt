...
class SettingsControlSemanticsTest {
    @Test
    fun titleOnlyAndDescribedRowsDoNotRetainIndependentChildActions() = runSharedControlSemanticsTest {
        ...
        for ((label, hint, toggle) in listOf(
            ...
            assertSingleSwitch(label, checked = false, hint = hint, minimumHeight = 64.dp)
