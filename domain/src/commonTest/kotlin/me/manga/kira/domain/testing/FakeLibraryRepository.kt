...
class FakeLibraryRepository : LibraryRepository {
    ...
    override suspend fun removeAllFromLibrary(owners: List<SavedWorkIdentity>): AppResult<Int> {
        ...
        return removeAllResult ?: AppResult.Success(removeAllPurgedCount ?: owners.distinct().size)
    }
    ...
    /** Explicit committed bulk count forwarded by the use case, never a selected-row estimate. */
